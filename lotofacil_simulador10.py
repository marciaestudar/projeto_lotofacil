# -*- coding: utf-8 -*-
"""lotofacil_simulador10.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1EaHtyab72MwQFN4q1lKYg0clMZsQJVee
"""
...
with tab2:
    ...
    if not df_oficial.empty:
        ...
        if 'Data Sorteio' in df_display.columns:
            ...
            df_display['Data Sorteio'] = df_display['Data Sorteio'].dt.strftime('%dd/%mm/%aaaa').fillna('Data Inválida')
        ...
        if submitted:
            ...
            if len(set(bolas)) != 15:
                ...
                novo_sorteio_dict = {
                    ...
                    'Data Sorteio': data_sorteio.strftime("%dd-%mm-%aaa") # Formato AAAA-MM-DD para consistência no CSV
                }
